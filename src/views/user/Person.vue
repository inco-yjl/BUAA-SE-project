...
<template>
  ...
  <div class="个人主页">
    ...
    <div class = "body-message">
      <div class = "left b_radius vertical">
      ...
      <div class = "midrecent">
            <span class="title recent">
              <img class="hot recent" style="height: 30px; width: 30px;" src="@/assets/img/RecentRead.png" />&nbsp;最近在看
            </span>
      </div>

      <div style = "position: relative; float: left; left: 40px; margin-top: 40px">
        <scroll></scroll>
      </div>
      <el-divider style="margin-top: 0; margin-bottom: 0;"></el-divider>
      </div>
      
      <div class = "midden vertical">
        <span v-if = "false" class = "mid">你还没有发表任何评论哦，快去试试吧</span>
        <div v-else>
          <div>
            <span class="title recent">
              <img class="hot recent" style="height: 30px; width: 30px;" src="@/assets/img/Comments.png" />&nbsp;我的最近评论
            </span>
          </div>
          <div class = "mid_message ">
            <img class = "showImg" src="@/assets/img/1.jpg">
            <el-button plain style = "position: relative; text-align: right; float: right;right: 175px">删除</el-button>
            <span class = "mid_message_font">
              “我在那之前从来没有为死亡而哀悼过，也从没有因死亡而恐惧。甚至都不曾意识。”“但是，拥有着和自己对等力量的生命在我眼前消失了。即便我同所有人一样，最初就知道有“死”存在，那却是我第一次真正的感受到它。”吉尔伽美什所说的“对等的生命”是指恩奇都吧。叙事诗上说，吉尔伽美什亲眼目睹了恩奇都的死亡，察觉到自己终有一日也会如此死去。
            </span> 
          </div>
          <div class = "mid_message ">
          ...
          <div class = "mid_message ">&nbsp</div>
        </div>
      </div>
      <div class = "right b_radius vertical">
        <div>
            <span class="title recent">
